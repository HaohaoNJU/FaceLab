...
class Solver(nn.Module):
    ...
    def train(self):
        ...
        steps = 0
        # writer.add_graph(self.net,torch.randn(1,3,112,112))
        ...
        # for epoch in range(4):
            ...
            if epoch % self.val_interval == 0 or epoch == self.start_epoch + self.epoch - 1:
                save_dir = os.path.join(self.io_fac.save_weight_path,"epoch{}.pth".format(epoch))
