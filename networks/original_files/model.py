    ...
    def __init__(self, in_channel, depth, stride):
        ...
        if in_channel == depth:
            ...
            self.shortcut_layer = Sequential(
                Conv2d(in_channel, depth, (1, 1), stride ,bias=False), BatchNorm2d(depth,eps=2e-5,momentum=0.9))
        self.res_layer = Sequential(
            BatchNorm2d(in_channel,eps=2e-5,momentum=0.9),
            Conv2d(in_channel, depth, (3, 3), (1, 1), 1 ,bias=False), PReLU(depth),
            Conv2d(depth, depth, (3, 3), stride, 1 ,bias=False), BatchNorm2d(depth,eps=2e-5,momentum=0.9))
...
class Arcface(Module):
    ...
    def __init__(self, conf,embedding_size=512, classnum=51332,  s=64., m=0.5):
